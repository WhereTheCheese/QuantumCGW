...
if __name__ == "__main__":
    ...
    f0_values = np.linspace(1, 8, 8) # Looks at a range of frequencys - Format (min #, max #, # of steps)
    fdot_values = np.linspace(-1e-15, -8e-15, 8)  # The derivitve of above, frequency per second - Format (min #, max #, # of steps)
    duration = 86400 # Total obserction time taken (seconds)
    dt = 0.02 #time step (the interval for sampling)
    noise_std = 1e-26 #Amount of noise added to the data
